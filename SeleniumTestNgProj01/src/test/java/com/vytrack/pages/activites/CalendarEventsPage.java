...
public class CalendarEventsPage extends BasePage {
    ...
    public void selectStartTime(String time) {
        ...
        String startTimeToSelect = "(//li[text()='" + time + "'])[1]";
        startTime.click();
        new WebDriverWait(Driver.getDriver(),Duration.ofSeconds(10)).until(ExpectedConditions.presenceOfElementLocated(By.xpath(startTimeToSelect)));
        Driver.getDriver().findElement(By.xpath(startTimeToSelect)).click();
    }
    ...
    public long differenceBetweenStartTimeAndEndTime() {
        ...
        try {
            new WebDriverWait(Driver.getDriver(),Duration.ofSeconds(3)).until(ExpectedConditions.invisibilityOf(startTime));
        } catch (Exception e) {
