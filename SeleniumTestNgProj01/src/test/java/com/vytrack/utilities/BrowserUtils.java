...
//        String target = System.getProperty("user.dir") + "/test-output/Screenshots/" + name + date + ".png";
        String target = "C:\\Users\\ostur\\IdeaProjects\\Spring2019FinalTestNGFramework\\test-output\\Screenshots\\" + name + date + ".png";
    ...
    public static void waitForsStaleness(By by) {
        new WebDriverWait(Driver.getDriver(), Duration.ofSeconds(Integer.parseInt(ConfigurationReader.getProperty("SHORT_WAIT")))).
