...
//        Assert.assertEquals(pages.loginPage().getErrorMessage(), "Invalid user name password.");
...
//    public void loginWithDataProvider2(String execute, String username, String password, String firstname, String lastname, String result) {
